      ...
      {({ getItemProps, getLabelProps, getMenuProps, isOpen, highlightedIndex, selectedItem, getToggleButtonProps, inputValue }) => {
        ...
        return (
          <div className="RampInputSelect--root">
            ...
            <div className="RampInputSelect--input" ref={inputRef} onClick={(event) => {
            ...
            <div className={classNames("RampInputSelect--dropdown-container", { "RampInputSelect--dropdown-container-opened": isOpen, })} {...getMenuProps()} style={{ top: dropdownPosition.top, left: dropdownPosition.left }}>
              {renderItems()}
            </div>
          </div>
        )
        ...
        function renderItems() {
          ...
          return items.map((item, index) => {
            ...
            return (
              <div key={parsedItem.value}  {...getItemProps({
                key: parsedItem.value, index, item,
